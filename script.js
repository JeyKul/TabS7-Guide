const steps = [
  ...
  { img: "assets/14.png", title: "Step 17", description: "And we're done.", help: null, buttons: [{ name: "Next steps (soon)", url: "./pages/next.html" }]},
];
